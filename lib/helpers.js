...
exports.pushSetValue = function pushSetValue(set,val) {
...
exports.validStreamRequest = function validStreamRequest(reqStream,savedStream) {
  // true if match
  return (reqStream.stream === savedStream.id && reqStream.cookie === savedStream.cookie);
}

exports.generateUniqueString = function generateUniqueString(chars, list) {
  while (true) {
    var str = exports.generateRandomString(chars);
    if (!list[str]) {
      break;
    }
  }
